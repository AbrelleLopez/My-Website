...
export default function Navbar({ darkMode, toggleDarkMode }) {
    ...
    return (
        ...
        >
            <div className="px-[4.8vw] py-[0.7vw] flex justify-between items-center">
                <img
                ...
                <ul className="flex flex-wrap gap-[2.1vw] items-center list-none text-[1.2vw]" style={{ color: darkMode ? '#FFFFFF' : '#000000' }}>
                    ...
                    <li>
                        <button
                            ...
                            style={{ padding: '0.7vw 1vw', fontSize: '1.2vw', backgroundColor: '#9544FF', color: '#FFFFFF',
                    ...
                    <li>
                        <button
                            ...
                            style={{ backgroundColor: '#9544FF', border: 'none', borderRadius: '5px', padding: '0.7vw',
